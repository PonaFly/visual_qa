...
def model_construct(vocabulary_len, max_text_length,lr=1e-5):  #vocabulary_len=12629, max_text_length=26
    ...
    data_concatenate = Concatenate(name='all_data_concat')([resn_flatten,lstm_flatten])
...
def fit(model,data_train,epochs,batch_size,steps):
